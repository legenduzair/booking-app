      ...
      {action === 'new' && (
          <div>
              <form>
                  ...
                  <p className='text-gray-500 text-sm'>Where your place is located.</p>
                  <input type="text" placeholder='Address' />
                  <h2 className='text-2xl mt-4'>Snapshots</h2>
                  <p className='text-gray-500 text-sm'>Showcase your place to the world!</p>
                  ...
                  <p className='text-gray-500 text-sm'>Select all the perks of living at your place.</p>
