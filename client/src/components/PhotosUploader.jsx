        ...
        {addedPhotos.length > 0 &&
          addedPhotos.map((link) => (
            <div className="h-16 sm:h-32 flex relative">
              ...
              <button onClick={ev => selectAsMainPhoto(ev, link)} className="hidden sm:block cursor-pointer absolute bottom-2 left-2 text-white bg-black py-2 px-3 bg-opacity-50 rounded-2xl">
                {link === addedPhotos[0] && (
